 ...
 * @see https://v0.dev/t/qmeo0Y8rLLk
 */
    ...
    (<div key="1" className="min-h-screen bg-white">
      <nav className="bg-transparent py-5">
        <div
          ...
          <div className="font-bold text-xl text-blue-600">Fjarmdhn</div>
          ...
          <div className="lg:hidden">
            <button aria-label="Open menu" className="text-gray-600 hover:text-gray-800">
      ...
      <header
        className="container mx-auto flex flex-col-reverse lg:flex-row items-center gap-12 mt-14 lg:mt-28">
        <div className="flex flex-col items-start space-y-8">
          <h1 className="font-bold text-4xl lg:text-5xl max-w-xl text-gray-900">
            Hello I'm
            <br />
            <span className="text-blue-600">Muhamad Fajar Ramadhan</span>
          </h1>
      ...
      <section className="bg-gray-50 py-20 mt-20" id="skills">
          ...
          <div className="flex flex-wrap justify-center mt-10">
            ...
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
              <div className="bg-white shadow rounded p-5 text-center">
                ...
                <h3 className="mt-4 text-xl font-semibold text-gray-700">JavaScript</h3>
              </div>
            </div>
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
              <div className="bg-white shadow rounded p-5 text-center">
      ...
      <section className="bg-gray-100 py-20 mt-20 lg:mt-60">
        <div className="container mx-auto">
            ...
            <div className="p-4 md:w-1/2 lg:w-1/3">
              <div className="h-full overflow-hidden">
                <img
                  ...
                  width="280" />
                <div className="p-6">
                  <h2 className="text-xl font-medium text-gray-900 mb-1">Project 1</h2>
                  <p className="leading-relaxed mb-5">Preview of project 1 description.</p>
            ...
            <div className="p-4 md:w-1/2 lg:w-1/3">
              <div className="h-full overflow-hidden">
                <img
                  ...
                  width="280" />
                <div className="p-6">
                  <h2 className="text-xl font-medium text-gray-900 mb-1">Project 2</h2>
                  <p className="leading-relaxed mb-5">Preview of project 2 description.</p>
                  <div className="flex items-center flex-wrap">
                    <a
                      className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0"
                      href="#">
            ...
            <div className="p-4 md:w-1/2 lg:w-1/3">
              <div className="h-full overflow-hidden">
                <img
                  ...
                  width="280" />
                <div className="p-6">
                  <h2 className="text-xl font-medium text-gray-900 mb-1">Project 3</h2>
                  <p className="leading-relaxed mb-5">Preview of project 3 description.</p>
                  <div className="flex items-center flex-wrap">
                    <a
                      className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0"
                      href="#">
      ...
      <footer className="bg-blue-600 py-10 text-white mt-20">
        <div className="container mx-auto text-center">
          <p className="text-xl">© Muhamad Fajar Ramadhan. All rights reserved.</p>
        </div>
      </footer>
    </div>)
  );
